            ...
            <nav className="flex-1 overflow-auto p-3 space-y-4">
              {sidebarSections.map((section) => (
                <div key={section.title} className="space-y-1.5">
                  <p className="px-2 pb-1 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground/90">
                    {section.title}
                  </p>
                ...
                <div className="space-y-1 max-h-44 overflow-auto pr-1">
                  {tables.map((table) => (
                    <button
                      ...
                      className="w-full text-left px-3 py-2 rounded-lg text-sm text-muted-foreground hover:bg-muted hover:text-foreground transition truncate"
                    >
                      {table.table_name}
                    </button>
                  ))}
